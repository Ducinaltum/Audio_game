function Modes() {
    chords = {
        ...
        _5_b3: new Grade("5/b3", new Chord('major', 10, "7"), 11),
        //_7_b3M: new Grade("2d", new Chord('dim'), 2),
        _5_b6: new Grade("5/b6", new Chord('major', 3, "7"), 11),
        _7_b6: new Grade("7/b6", new Chord('dim'), 7),
        _5_b7: new Grade("5/b7", new Chord('major', 5, "7"), 11),
        _7_b7: new Grade("7/b7", new Chord('dim'), 9),
        _2lydian: new Grade("2M", new Chord('major'), 2),
        _7lydian: new Grade("7m", new Chord('minor'), 11),
        _7mixolydian: new Grade("b7M", new Chord('major'), 10),
        _5mixolydian: new Grade("5m", new Chord('minor'), 7),
        _4dorian: new Grade("4M", new Chord('major'), 5),
        _2dorian: new Grade("2m", new Chord('minor'), 2),
        _2phrygian: new Grade("b2M", new Chord('major'), 1),
        _7Frig: new Grade("b7m", new Chord('minor'), 10),
        _7aeolian: new Grade("b7M", new Chord('major'), 10),
        _5aeolian: new Grade("5m", new Chord('minor'), 7),
        _5locrian: new Grade("b5M", new Chord('major'), 6),
        _3locrian: new Grade("b3m", new Chord('minor'), 3),
    }
